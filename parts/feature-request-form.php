...
<form action="<?php echo W_ROOT . '/form-action.php'; ?>" method="post" id="feature_request_form" name="feature_request_form">
    ...
    <div class="form-group row">
        <label for="f_title" class="col-2 col-xs-12 col-form-label">Title: <span class="text-danger ml-1">*</span></label>
    ...
    <div class="form-group row">
        <label for="f_dependencies" class="col-2 col-xs-12 col-form-label"><?php echo "Abhängigkeit: "; ?>:
