<div class="form-row">
    <div class="form-group col-12">
        ...
        <textarea class="form-control" name="f_desc" id="f_desc" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo(!$f_id ? "" : $feature_info['f_desc']); ?></textarea>
    </div>
    <div class="form-group col-6">
        ...
        <select class="form-control" name="f_type" id="f_type" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>>
    ...
    <div class="form-group col-6">
        ...
        <select class="form-control" name="f_status_id" id="f_status_id" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>>
            <option value="">--bitte w<span>&#228;</span>hlen--</option>
			<?php
    ...
    <div class="form-group col-6">
        ...
        <select class="form-control" name="f_epic" id="f_epic" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>>
            <optgroup>
                <option value="">--bitte w<span>&#228;</span>hlen--</option>
				<?php
    ...
    <div class="form-group col-6">
        ...
        <select class="form-control" name="topic_id" id="topic_id" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>>
            <option value="">--bitte w<span>&#228;</span>hlen--</option>
            <?php
            foreach($topics as $t){
