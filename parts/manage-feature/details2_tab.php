...
<div class="form-row">
    <div class="form-group col-4">
        <label for="created_date" class="col-form-label">Erstellt am: </label>
        <input type="text" name="created_date" id="created_date" value="<?php echo !$f_id ? date("Y-m-d") : date("Y-m-d", strtotime($feature_info['created_date'])); ?>" disabled="disabled" class="form-control">
    </div>
</div>