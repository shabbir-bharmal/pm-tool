<div class="form-row">
    <div class="form-group col-12">
        ...
        <textarea name="f_benefit" id="f_benefit" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_benefit']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_dependencies" id="f_dependencies" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_dependencies']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_acceptance_criteria" id="f_acceptance_criteria" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_acceptance_criteria']; ?></textarea>
    </div>
</div>