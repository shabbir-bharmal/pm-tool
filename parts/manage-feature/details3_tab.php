<div class="form-row">
    <div class="form-group col-12">
        ...
        <textarea name="f_context" id="f_context" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_context']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_problemdessc" id="f_problemdessc" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_problemdessc']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_currentstate" id="f_currentstate" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_currentstate']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_targetstate" id="f_targetstate" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_targetstate']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_inscope" id="f_inscope" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_inscope']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_outofscope" id="f_outofscope" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_outofscope']; ?></textarea>
    </div>
    <div class="form-group col-12">
        ...
        <textarea name="f_risks" id="f_risks" class="form-control" <?php if ($can_edit_roadmap == 0){echo "disabled";} ?>><?php echo !$f_id ? '' : $feature_info['f_risks']; ?></textarea>
    </div>
</div>