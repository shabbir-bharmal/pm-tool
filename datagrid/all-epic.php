...
<html>
<head>
<title>All Epics Live data</title>
...
<body>
 ...
 <div class="container-fluid">  
  <div class="data-main-heading">
    <h1 align="center">All Epics Live data</h1>
  </div>
...
$faq = new epic();
$allepicsResult = $faq->getallepics();
foreach ($allepicsResult as $k => $v) {
    ?>
        <tr class="table-row">               
                 <td><a style="text-decoration:none" href="https://pm.mastaz.ch/epic-request.php?e_id=<?php echo $allepicsResult[$k]["e_id"];?>"><?php echo $allepicsResult[$k]["e_title"]; ?></a></td>
                 <td><?php echo $allepicsResult[$k]["staff_firstname"]; ?>&nbsp; <?php echo $allepicsResult[$k]["staff_lastname"]; ?></td>
                 <td><?php echo $allepicsResult[$k]["epicsname"]; ?></td>
                 <td><?php echo $allepicsResult[$k]["teamname"]; ?></td>               
				</tr>
    <?php
}
?>
